...
public class WxMenuController implements WxMpMenuService {
    ...
    public String menuCreateSample() throws WxErrorException {
        ...
        button1.setName("线上商城");
        button1.setUrl("http://m1m8057172.51mypc.cn/weixin-java-mp-demo/static/mall/mall_index.html");
        
        WxMenuButton button2 = new WxMenuButton();
        //button2.setType(WxConsts.BUTTON_CLICK);
        button2.setName("服务中心");
        ArrayList<WxMenuButton> arrayList = new ArrayList<WxMenuButton>();
        WxMenuButton button21 = new WxMenuButton();
        button21.setType(WxConsts.BUTTON_VIEW);
        button21.setName("联系客服");
        button21.setUrl("http://m1m8057172.51mypc.cn/weixin-java-mp-demo/static/offline-feel/contact_us.html");
        
        WxMenuButton button22 = new WxMenuButton();
        button22.setType(WxConsts.BUTTON_VIEW);
        button22.setName("线下体验");
        button22.setUrl("http://m1m8057172.51mypc.cn/weixin-java-mp-demo/static/offline-feel/index.html");
        
        arrayList.add(button21);
        arrayList.add(button22);
        
        button2.setSubButtons(arrayList);

        WxMenuButton button3 = new WxMenuButton();
        button3.setName("个人中心");
        button3.setUrl("http://m1m8057172.51mypc.cn/weixin-java-mp-demo/static/profile/profile.html");
